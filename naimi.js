...
const isOwner = setting.ownerNumber == m.sender ? true : ["6283811034750@s.whatsapp.net"].includes(m.sender) ? true : false
...
url: 'https://instagram.com/fdev90_'
}
}, {
quickReplyButton: {
displayText: 'MENU',
